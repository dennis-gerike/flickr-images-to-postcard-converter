...
Then('the final image should contain an empty caption segment', async function () {
    const referenceImagePath = `${getFixturesFolderPath()}/reference-images/${process.env[EnvironmentVariables.FLICKR_IMAGE_ID]}-${process.env[EnvironmentVariables.ASPECT_RATIO]}-empty-caption.jpg`
